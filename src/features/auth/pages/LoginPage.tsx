            ...
            >
              ...
              <Box className="flex items-center justify-between pt-1">
                <Box className="flex items-center space-x-2.5 group">
                  <Checkbox
                    id="remember"
                    className="w-5 h-5 bg-white border-slate-300 rounded-md data-[state=checked]:bg-blue-600 data-[state=checked]:text-white data-[state=checked]:border-blue-600 focus-visible:ring-blue-600/20 transition-all"
                  />
                  <Label
                    htmlFor="remember"
                    className="text-sm font-semibold text-slate-700 group-hover:text-slate-900 transition-colors cursor-pointer"
                  >
                    Ingat saya
                  </Label>
                </Box>
              ...
              <Box className="pt-4">
                <Button
                  type="button"
                  className="w-full h-auto flex items-center justify-center py-3 px-4 bg-linear-to-r from-blue-600 to-blue-400 hover:to-blue-600 text-white text-[15px] font-bold rounded-xl hover:opacity-90 transition-all duration-300 shadow-[0_8px_20px_rgba(37,99,235,0.25)] group border-0"
                >
                  Masuk ke Sistem
